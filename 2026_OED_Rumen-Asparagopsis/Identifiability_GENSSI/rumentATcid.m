% Muñoz-Tamayo (2026)
% ODE equations of a dynamic model representing the effect of Asparagopsis
% taxiformis on in vitro rumen fermentation and methane production. 
function model = rumentATcid()
    ...
    syms k_Ibr p1 p2 p3 p4 
     ...
     model.sym.p = [k_Ibr; p1; p2; p3; p4 ];
 
     
    
     % State variables
     model.sym.x = [Z_ndf;Z_nsc; Z_pro; S_su; S_aa; S_ac; S_bu; S_pr; S_IN ;S_IC; S_h2; S_ch4; X_su; X_aa; X_h2; Sg_co2; Sg_h2; Sg_ch4; S_br];
    ...
    % Initial conditions
    Cinit = [   1.95522776604731 0.93422083074134 0.227516759726442 0.0011433984762997 0.000123103733949453 0.0283025432574042 0.00791526592799744 0.0125473449350624 0.0130988147820988 0.000641288812280987 1.33573345024744e-06 0.000253300183029449 0.00431162693103049 0.00318990547634962 0.000309759444473673 0.00150726539620904 4.905622812815e-06 0.00063911886828679 1e-4]; 
    %Cinit = [];
    model.sym.x0  = Cinit'; 
    
    % Observables
   
    model.sym.y = [S_ac; S_bu; S_pr; Sg_co2; Sg_h2; Sg_ch4; S_br ]; 
